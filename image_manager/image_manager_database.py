...
class imagemanager_Database(QWidget):


    # Init
    def __init__(self, parent):
        super(imagemanager_Database, self).__init__(parent)
        self.Variables()
    def Variables(self):
        # Widget
        self.widget_width = 1
    ...
    def Database_Run(self, directory):
        self.database_path = os.path.normpath( directory + "\\DATABASE\\image_manager_database.db" )
